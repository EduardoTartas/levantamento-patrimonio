...
const authRoutes = {
    ...
    , "/password/reset/token": {
        patch: {
            ...
            description: `
            + Caso de uso: Permite que o próprio usuário atualize sua senha.
            + Função de Negócio:
                - Recebe o token de autenticação do usuário.
                - Valida o token e permite a atualização da senha.
            + Regras de Negócio:
                - Verificar se o token é válido e pertence ao usuário, confiando na portabilidade do token.
                - Validar a nova senha conforme regras de segurança (tamanho, complexidade).    
            + Resultado Esperado:
                - 200 OK com mensagem de sucesso e dados do usuário atualizado.
            `,
            security: [],
            parameters: [
                {
                    ...
                    schema: {
                        type: "string",
                        example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4NDFmNWVhMmQ5YWYxOWVlN2Y1YmY3OCIsImlhdCI6MTc0OTQ4MjI4NSwiZXhwIjoxNzQ5NDg1ODg1fQ.RBQ1OwySYxLWxgq7AGGz5o_y1OQSpamBkelr82Rs06Y"
                    },
                    description: "Token de recuperação de senha, passado como query na URL."
    ...
    "/password/reset/code": {
        patch: {
            ...
            + Caso de uso: Permite que o próprio usuário atualize sua senha.
            + Função de Negócio:
                - Recebe o código de recuperação de senha e a nova senha.
                - Valida o código e permite a atualização da senha.
            + Regras de Negócio:
                - Verificar se o código de recuperação é válido e pertence ao usuário.
                - Validar a nova senha conforme regras de segurança (tamanho, complexidade).
            + Resultado Esperado:
                - 200 OK com mensagem de sucesso e dados do usuário atualizado.
            `,
            ...
            parameters: [
                {
                    ...
                    description: "Código de recuperação de senha, passado como query na URL."
